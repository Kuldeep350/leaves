                        ...
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-success"></i> $4.00</h2>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-block">
                                ...
                                <div class="text-right">
                                    <h2 class="font-light m-b-0"><i class="ti-arrow-up text-info"></i> $50</h2>
                                    <span class="text-muted">Todays Income</span>
                                </div>
                                <span class="text-info">8%</span>
                                <div class="progress">
                                    <div class="progress-bar bg-info" role="progressbar" style="width: 8%; height: 6px;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                </div>
                            </div>
                        </div>
                    </div>
